                            ...
                            <div className=' w-full flex items-center justify-between ' >
                                ...
                                <button onClick={() => setOpen(false)} className=' bg-[#EFEFFE] w-[32px] h-[32px] rounded-full flex justify-center items-center ' >
                                    <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10.2677 1.7334L1.73438 10.2667" stroke="#303179" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                        <path d="M1.73438 1.7334L10.2677 10.2667" stroke="#303179" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </button>
                            </div>
                            ...
                            <div className=' text-[#262626] w-full flex flex-col items-center ' >
                                <svg width="112" height="112" viewBox="0 0 112 112" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g id="warning">
                                        ...
                                        <g id="Group 12">
                                            <g id="Path">
                                                <path fillRule="evenodd" clipRule="evenodd" d="M55.7656 29.8733V61.5716V29.8733Z" fill="#98A2B3" />
                                                <path d="M55.7656 29.8733V61.5716" stroke="white" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
                                            </g>
                                            <g id="Path_2">
                                                <path fillRule="evenodd" clipRule="evenodd" d="M55.9301 79.4068V80.9493V79.4068Z" fill="#98A2B3" />
                                                <path d="M55.9301 79.4068V80.9493" stroke="white" strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
                                            </g>
                                        </g>
                                    </g>
                                </svg>
                        ...
                        <div className=' rounded-lg px-6 py-9 ' >
                            <div className=' text-[#080707] w-full flex flex-col items-center ' >
                                <svg width="146" height="146" viewBox="0 0 146 146" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M73 32.167L83.7255 39.9907L97.0012 39.9655L101.08 52.5994L111.835 60.3822L107.708 73.0003L111.835 85.6184L101.08 93.4013L97.0012 106.035L83.7255 106.01L73 113.834L62.2745 106.01L48.9988 106.035L44.9203 93.4013L34.1652 85.6184L38.2917 73.0003L34.1652 60.3822L44.9203 52.5994L48.9988 39.9655L62.2745 39.9907L73 32.167Z" fill="#40B274" stroke="#009845" strokeWidth="2.33333" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M58.7083 73.0003L68.9167 83.2087L89.3333 62.792" stroke="white" strokeWidth="2.33333" strokeLinecap="round" strokeLinejoin="round" />
                                </svg>
