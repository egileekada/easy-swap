                ...
                <div className=' w-full flex lg:flex-row flex-col  gap-6 ' >
                    <div role="button" onClick={()=> setTab(2)} className=' lg:w-[423px] flex lg:flex-col flex-col px-6 rounded-xl bg-[#F6F7FF] border border-[#D0D5DD] justify-center items-center py-6 ' >
                        <div className=' w-full flex flex-col ' >
                            ...
                            <p className=' mt-3 font-normal lg:text-left text-sm ' >To receive assistance from our support team, please submit a new ticket via our customer support system. We are available 24/7 and will respond to your inquiry promptly.</p>
                            {/* </div> */}
                        </div>
                        <button className='bg-[#303179]  mt-4 lg:mt-auto ml-auto text-white h-[45px] w-[150px] rounded-md px-3 font-semibold text-sm ' >Generate ticket</button>
                    </div>
                    <div role="button" onClick={()=> setTab(1)} className=' lg:w-[423px] flex lg:flex-col flex-col p-6 rounded-xl bg-[#F6F7FF] border border-[#D0D5DD] lg:h-[247px] justify-center items-center ' >
                        <div className=' w-full flex flex-col ' >
                            <div className=' w-full flex gap-4 items-center ' >
                                ...
                                <p className=' text-2xl font-semibold lg:text-left text-[#303179] ' >Call Center</p>
                            </div> 
            ...
            {tab === 2 && (
                <> 
                    <div role="button" onClick={()=> setTab(0)} className=' flex items-center gap-3 ' >
                        ...
                        <p className=' text-2xl font-semibold ' >New Ticket</p>
                    </div>
                    <div className=' w-full flex flex-col items-center py-12 ' >
                        <p className=' text-[#1D2939] font-semibold text-3xl ' >Provide relevant information</p>
                        <p className='  ' >Please, enter your reason in detail below.</p>
                    </div>
                    <SupportChat />
                </>
            )}
