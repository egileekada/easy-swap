                ...
                <div className=' w-full ' > 
                    ...
                    {tab.includes("one") && (
                        <div className=' px-6 ' > 
                            ...
                            <p className=' mt-2 font-medium text-left mb-6 ' >Ezyswap is a one-stop solution for exchanging naira for crypto. You can easily change your crypto to naira within minutes without extra charges and hidden fees.</p>
                        </div>
                    ) }
                </div> 
                <div className=' w-full ' > 
                    <div role='button' onClick={()=> setTab("two")} className=' border py-5 rounded-2xl border-[#00000033] w-full px-5 flex items-center justify-between ' >
                        <p className=' font-medium text-xl ' >Question 2</p>
                    ...
                    {tab.includes("two") && (
                        <div className=' px-6 ' > 
                            ...
                            <p className=' mt-2 font-medium text-left mb-6 ' >Our exchange rates are dynamic and change based on the market. Ezyswap offers a competitive exchange rate that provides value for money. </p>
                        </div>
                    ) }
                </div> 
                <div className=' w-full ' > 
                    <div role='button' onClick={()=> setTab("three")} className=' border py-5 rounded-2xl border-[#00000033] w-full px-5 flex items-center justify-between ' >
                        <p className=' font-medium text-xl ' >Question 3</p>
                    ...
                    {tab.includes("three") && (
                        <div className=' px-6 ' > 
                            ...
                            <p className=' mt-2 font-medium text-left mb-6 ' >We complete transactions within minutes. Once we confirm your crypto has entered the network, a naira payment is made automatically, and you receive an alert instantly.</p>
                        </div>
                    ) }
                </div> 
                <div className=' w-full ' > 
                    <div role='button' onClick={()=> setTab("four")} className=' border py-5 rounded-2xl border-[#00000033] w-full px-5 flex items-center justify-between ' >
                        <p className=' font-medium text-xl ' >Question 4</p>
                    ...
                    {tab.includes("four") && (
                        <div className=' px-6 ' > 
                            ...
                            <p className=' mt-2 font-medium text-left mb-6 ' >You can calculate your money using the rate calculator before selling your crypto. Ezyswap also provides an automatic calculator that provides the amount you will receive when selling your crypto.</p>
                        </div>
                    ) }
                </div> 
                <div className=' w-full ' > 
                    <div role='button' onClick={()=> setTab("five")} className=' border py-5 rounded-2xl border-[#00000033] w-full px-5 flex items-center justify-between ' >
                        <p className=' font-medium text-xl ' >Question 5</p>
                    ...
                    {tab.includes("five") && (
                        <div className=' px-6 ' > 
                            ...
                            <p className=' mt-2 font-medium text-left mb-6 ' >Ezyswap is safe, and you can do transactions with full assurance. We integrate the latest security measures to safeguard your details and transactions.</p>
                        </div>
                    ) }
                </div> 
            </motion.div>
