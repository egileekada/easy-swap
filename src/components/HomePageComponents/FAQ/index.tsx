            ...
            <motion.div ref={ref} initial={{x: -200}} animate={controls}  
                ...
                <div className=' w-full ' > 
                    <div role='button' onClick={()=> clickHandler("one")} className=' border py-5 rounded-2xl border-[#00000033] w-full px-5 flex items-center justify-between ' >
                        <p className=' font-medium text-xs lg:text-xl text-left ' >What is Ezyswap?</p>
                        <div className="w-fit" >
                    ...
                    {tab.includes("one") && (
                        <div className=' px-6 pt-4 pb-6 ' > 
                            ...
                            <p className=' mt-2 lg:text-base text-sm font-medium text-left ' >Ezyswap is a one-stop solution for exchanging naira for crypto. You can easily change your crypto to naira within minutes without extra charges and hidden fees.</p>
                        </div>
                    ) }
                </div> 
                <div className=' w-full ' > 
                    <div role='button' onClick={()=> clickHandler("two")} className=' border py-5 rounded-2xl border-[#00000033] w-full px-5 flex items-center justify-between ' >
                        <p className=' font-medium text-xs lg:text-xl text-left ' >What is the current exchange rate?</p>
                    ...
                    {tab.includes("two") && (
                        <div className=' px-6 pt-4 pb-6 ' > 
                            ...
                            <p className=' mt-2 lg:text-base text-sm font-medium text-left ' >Our exchange rates are dynamic and change based on the market. Ezyswap offers a competitive exchange rate that provides value for money. </p>
                        </div>
                    ) }
                </div> 
                <div className=' w-full ' > 
                    <div role='button' onClick={()=> clickHandler("three")} className=' border py-5 rounded-2xl border-[#00000033] w-full px-5 flex items-center justify-between ' >
                        <p className=' font-medium text-xs lg:text-xl text-left ' >How soon will I get an alert?</p>
                        <div className="w-fit ml-3" >
                    ...
                    {tab.includes("three") && (
                        <div className=' px-6 pt-4 pb-6 ' > 
                            ...
                            <p className=' mt-2 lg:text-base text-sm font-medium text-left ' >We complete transactions within minutes. Once we confirm your crypto has entered the network, a naira payment is made automatically, and you receive an alert instantly.</p>
                        </div>
                    ) }
                </div> 
                <div className=' w-full ' > 
                    <div role='button' onClick={()=> clickHandler("four")} className=' border py-5 rounded-2xl border-[#00000033] w-full px-5 flex items-center justify-between ' >
                        <p className=' font-medium text-xs lg:text-xl text-left ' >How do I calculate my money?</p>
                        <div className="w-fit ml-3" >
                    ...
                    {tab.includes("four") && (
                        <div className=' px-6 pt-4 pb-6 ' > 
                            ...
                            <p className=' mt-2 lg:text-base text-sm font-medium text-left ' >You can calculate your money using the rate calculator before selling your crypto. Ezyswap also provides an automatic calculator that provides the amount you will receive when selling your crypto.</p>
                        </div>
                    ) }
                </div> 
                <div className=' w-full ' > 
                    <div role='button' onClick={()=> clickHandler("five")} className=' border py-5 rounded-2xl border-[#00000033] w-full px-5 flex items-center justify-between ' >
                        <p className=' font-medium text-xs lg:text-xl text-left ' >Is Ezyswap secure?</p>
                        <div className="w-fit ml-3" >
                    ...
                    {tab.includes("five") && (
                        <div className=' px-6 pt-4 pb-6 ' > 
                            ...
                            <p className=' mt-2 lg:text-base text-sm font-medium text-left ' >Ezyswap is safe, and you can do transactions with full assurance. We integrate the latest security measures to safeguard your details and transactions.</p>
                        </div>
                    ) }
                </div> 
            </motion.div>
