...
export default function HeroSection() {
    return (
        <div className=' bg-[#f8f8f8] h-[70vh] py-24 items-center w-full justify-center px-16 flex ' >
            <div className='w-[1280px] max-[1280px]:w-full flex items-center ' >
                <div className=' w-full pt-8 ' >
                    <h1 className=' text-[#303179] text-5xl leading-[1.1] font-bold ' >Buy, sell, and swap your cryptocurrencies with ease.</h1>
