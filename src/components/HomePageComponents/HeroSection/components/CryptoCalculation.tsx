...
export default function CryptoCalculation() {
    return (
        <div className=' w-[450px] h-fit rounded-lg bg-white py-9 px-6 ' >
            ...
            <div className=' w-full border border-[#94A3B8] h-[60px] mt-4 rounded-lg px-[26px] flex items-center justify-between ' >
                <div className=' w-full ' >
            ...
            <button style={{boxShadow: "0px 1px 0px rgba(0, 0, 0, 0.05)"}} className=' bg-[#303179] text-[#FCFCFD] font-sembold w-full mt-6 rounded h-[45px] ' >Sell crypto in minutes</button>
        </div>
    )
}
