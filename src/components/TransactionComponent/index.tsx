                                                    ...
                                                    <div className=' w-full  fixed bg-white overflow-y-auto inset-0 z-[100]  ' >
                                                        <div className=' bg-[#303179] w-full pt-9 pb-6 px-6 ' >
                                                            ...
                                                            <div className=' w-full flex items-center text-white justify-between mt-2 ' >
                                                                <div>
                                                                    <p className=' font-semibold text-[26px] ' >Sell order {(item?.transaction_status === "FAILED" || item?.transaction_status === "CANCELLED") ? "Cancelled" : item?.transaction_status === "PENDING" ? "pending" : "completed"}</p>
                                                                ...
                                                                {(item?.transaction_status === "FAILED" || item?.transaction_status === "CANCELLED") ? (
