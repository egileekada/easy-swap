...
export default function TransactionComponent() {
    return (
        <div className=' w-full  ' >
            <div className=' grid grid-cols-5 gap-5 font-medium  ' >
                <div className=' w-full ' >
                    <p className=' text-[#647488] font-normal mb-2 ' >Type</p>
                ...
                <div className=' w-full ' >
                    <p className=' text-[#647488] font-normal mb-2 ' >Assets</p>
                    <Select fontSize="sm" backgroundColor="white" >
                        <option>All</option>
                    </Select>
                </div>
                <div className=' w-full ' >
                    <p className=' text-[#647488] font-normal mb-2 ' >Status</p>
                    <Select fontSize="sm" backgroundColor="white" >
                        <option>All</option>
                    </Select>
                </div>
