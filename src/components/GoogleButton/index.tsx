...
export default function GoogleButton() {
    ...
    return (
        <> 
            <div onClick={()=> setShowModal(false)} role='button' className=' lg:w-full flex items-center lg:bg-transparent bg-[#F2F4F7] rounded h-[45px]  justify-center font-medium text-[#344054] mt-4 lg:mt-8 gap-2 ' >
