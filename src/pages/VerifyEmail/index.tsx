        ...
        <div className=' w-full h-screen flex-1 pb-20 flex flex-col items-center justify-center ' >
            ...
            {!tab && ( 
                <div className=' w-[560px] text-center ' > 
                    <p className=' text-4xl font-semibold text-[#1E293B] ' >Verify your email address</p>
                    <p className=' text-[#475569] mt-2 ' >We emailed you a six-digit code to jayboss@gmail.com. Enter the code below to confirm your email address</p>
            ...
            {tab && ( 
                <div className=' w-[560px] text-center ' > 
                    <p className=' text-4xl font-semibold text-[#1E293B] ' >Welcome to Easyswap</p>
                    <p className=' text-[#475569] mt-2 ' >Account created successfully 🎉 </p>  
                    <ButtonComponent  bgcolor=' mt-10 bg-[#303179] text-[#fff]' name="Get Started" />
                </div> 
            )}
        </div>
    )
