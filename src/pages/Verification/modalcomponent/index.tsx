...
export default function VerificationModal() {
    ...
    //     "govt_id_photo": "http://example.com",
    //     "govt_id_number": "string",
    //     "govt_id_type": "string",
    //     "expiry_date": "2019-08-24",
    //     "selfie_photo": "http://example.com", 
    //     }
    ...
    const submit =async()=> {
        ...
        const responses = await handleVerifyUser(formdata)
    ...
    return (
        <div className='  w-full bg-white text-[#475467] pt-12 pb-6 px-6  ' >
            <div className=' w-full flex items-center justify-between ' >
                <svg role='button'  width="23" height="20" viewBox="0 0 23 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {isShown === 0 && (
                <> 
                    ...
                    <button onClick={()=> setIsShown(1)} className=' h-[50px] w-full rounded-md bg-[#303179] mt-5 text-white ' >Continue</button>
